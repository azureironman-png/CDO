...
# ============================================================================
# AGENT 2 TESTS: UI Engine (Angular CDE reference)
# ============================================================================
def test_ui_agent_generation():
    ...
    # Run Agent 02 to generate Angular UI updates from CDE reference
    final_state = run_ui_agent(state_with_schema)

    assert final_state.ui_code != ""
    # Agent 02 must target the Angular Customer Data Essentials reference
    assert "references/cdo_customer_ui" in final_state.ui_code or "aadhaar_no" in final_state.ui_code
    assert "streamlit" not in final_state.ui_code.lower()
